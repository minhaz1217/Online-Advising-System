...
public class DbSeeder implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        this.courseDescriptionRepository.save(new CourseDescription( "CSE350","01","08:30 - 10:00","ST","AB2-405","40"));
        this.courseDescriptionRepository.save(new CourseDescription( "CSE350","02","11:50 - 01:20","T","226","40"));
        this.courseDescriptionRepository.save(new CourseDescription( "CSE350","02","11:50 - 01:20","R","225","40"));
        this.courseDescriptionRepository.save(new CourseDescription( "CSE350","03","11:50 - 01:20","MW","AB2-205","40"));
        this.courseDescriptionRepository.save(new CourseDescription( "CSE360","01","08:30 - 10:00","SR","112","40"));
        this.courseDescriptionRepository.save(new CourseDescription( "CSE360","02","10:10 - 11:40","SR","112","40"));
        this.courseDescriptionRepository.save(new CourseDescription( "CSE360","03","08:30 - 10:00","MW","435","40"));
        this.courseDescriptionRepository.save(new CourseDescription( "CSE365","01","10:10 - 11:40","ST","AB1-601","40"));
        this.courseDescriptionRepository.save(new CourseDescription( "CSE365","02","01:30 - 03:00","T","436","40"));
        this.courseDescriptionRepository.save(new CourseDescription( "CSE365","02","01:30 - 03:00","S","AB2-503","40"));
        this.courseDescriptionRepository.save(new CourseDescription( "CSE365","03","10:10 - 11:40","MW","109","40"));
        this.courseDescriptionRepository.save(new CourseDescription( "CSE375","01","11:50 - 01:20","ST","115","40"));
        this.courseDescriptionRepository.save(new CourseDescription( "CSE375","02","03:10 - 04:40","SR","Reading Course","40"));
        this.courseDescriptionRepository.save(new CourseDescription( "CSE375","03","01:30 - 03:00","TR","109","40"));
        this.courseDescriptionRepository.save(new CourseDescription( "CSE498","01","08:30 - 10:00","MW","221","40"));
        this.courseDescriptionRepository.save(new CourseDescription( "CSE498","02","03:10 - 04:40","SR","337","40"));
        this.courseDescriptionRepository.save(new CourseDescription( "CSE411","01","10:10 - 11:40","T","AB2-304","40"));
        this.courseDescriptionRepository.save(new CourseDescription( "CSE411","01","10:10 - 11:40","R","AB2-304","40"));
        this.courseDescriptionRepository.save(new CourseDescription( "CSE411","02","10:10 - 11:40","MW","AB1-301","40"));
        this.courseDescriptionRepository.save(new CourseDescription( "CSE411","03","01:30 - 03:00","TR","AB2-205","40"));
        this.courseDescriptionRepository.save(new CourseDescription( "GEN201","01","01:30 - 03:00","MW","219","40"));
        this.courseDescriptionRepository.save(new CourseDescription( "GEN201","02","01:30 - 03:00","SR","550 (Lecture Gallery)","40"));
        this.courseDescriptionRepository.save(new CourseDescription( "STA102","01","01:30 - 03:00","MW","AB1-302","40"));
        this.courseDescriptionRepository.save(new CourseDescription( "STA102","02","03:10 - 04:40","TR","AB1-302","40"));
        this.courseDescriptionRepository.save(new CourseDescription( "STA102","03","01:30 - 03:00","ST","AB1-402","40"));
        this.courseDescriptionRepository.save(new CourseDescription( "STA102","04","11:50 - 01:20","MW","AB1-402","40"));
        this.courseDescriptionRepository.save(new CourseDescription( "STA102","05","11:50 - 01:20","MW","AB1-302","40"));
        this.courseDescriptionRepository.save(new CourseDescription( "CSE205","01","10:10 - 11:40","ST","532","40"));
        this.courseDescriptionRepository.save(new CourseDescription( "CSE205","02","01:30 - 03:00","ST","532","40"));
        this.courseDescriptionRepository.save(new CourseDescription( "CSE205","03","10:10 - 11:40","MW","532","40"));
        this.courseDescriptionRepository.save(new CourseDescription( "CSE205","04","01:30 - 03:00","MW","532","40"));
        this.courseDescriptionRepository.save(new CourseDescription( "MAT205","01","01:30 - 03:00","ST","437","40"));
        this.courseDescriptionRepository.save(new CourseDescription( "MAT205","02","11:50 - 01:20","MW","437","40"));
        this.courseDescriptionRepository.save(new CourseDescription( "MAT205","03","10:10 - 11:40","ST","AB2-503","40"));
        this.courseDescriptionRepository.save(new CourseDescription( "MAT205","04","08:30 - 10:00","MW","436","40"));
        this.courseDescriptionRepository.save(new CourseDescription( "MAT205","05","08:30 - 10:00","ST","AB1-502","40"));
        this.courseDescriptionRepository.save(new CourseDescription( "MAT205","06","01:30 - 03:00","MW","AB1-502","40"));
        this.courseDescriptionRepository.save(new CourseDescription( "CSE225","01","10:10 - 11:40","MW","212","40"));
        this.courseDescriptionRepository.save(new CourseDescription( "CSE225","02","11:50 - 01:20","MW","212","40"));
        this.courseDescriptionRepository.save(new CourseDescription( "CSE225","03","10:10 - 11:40","T","AB2-405","40"));
        this.courseDescriptionRepository.save(new CourseDescription( "CSE225","03","10:10 - 11:40","R","AB2-404","40"));
        this.courseDescriptionRepository.save(new CourseDescription( "CSE225","04","01:30 - 03:00","T","212","40"));
        this.courseDescriptionRepository.save(new CourseDescription( "CSE225","04","01:30 - 03:00","R","107","40"));
        this.courseDescriptionRepository.save(new CourseDescription( "CSE225","05","08:30 - 10:00","MW","AB1-301","40"));
        this.courseDescriptionRepository.save(new CourseDescription( "CSE251","01","08:30 - 10:00","TR","AB1-301","40"));
        this.courseDescriptionRepository.save(new CourseDescription( "CSE251","02","01:30 - 03:00","TR","AB1-501","40"));
        this.courseDescriptionRepository.save(new CourseDescription( "CSE251","03","01:30 - 03:00","MW","TBA","40"));
        this.courseDescriptionRepository.save(new CourseDescription( "CSE325","01","08:30 - 10:00","MW","108","40"));
        this.courseDescriptionRepository.save(new CourseDescription( "CSE325","02","11:50 - 01:20","T","AB2-203","40"));
        this.courseDescriptionRepository.save(new CourseDescription( "CSE325","02","11:50 - 01:20","R","114","40"));
        this.courseDescriptionRepository.save(new CourseDescription( "CSE325","03","08:30 - 10:00","SR","AB1-701","40"));
        this.courseDescriptionRepository.save(new CourseDescription( "CSE325","04","03:10 - 04:40","MW","AB1-501","40"));
        this.courseDescriptionRepository.save(new CourseDescription( "ENG101","01","08:30 - 10:00","MW","223","40"));
        ...
        this.courseDescriptionRepository.save(new CourseDescription( "ENG101","02","08:30 - 10:00","ST","241","40"));
        ...
        this.courseDescriptionRepository.save(new CourseDescription( "ENG101","03","03:10 - 04:40","MW","221","40"));
        this.courseDescriptionRepository.save(new CourseDescription( "ENG101","04","08:30 - 10:00","MW","111","40"));
        this.courseDescriptionRepository.save(new CourseDescription( "ENG101","05","11:50 - 01:20","MW","AB2-303","40"));
        this.courseDescriptionRepository.save(new CourseDescription( "ENG101","06","11:50 - 01:20","MW","222","40"));
        this.courseDescriptionRepository.save(new CourseDescription( "ENG101","07","08:30 - 10:00","R","223","40"));
        this.courseDescriptionRepository.save(new CourseDescription( "ENG101","07","08:30 - 10:00","T","226","40"));
        this.courseDescriptionRepository.save(new CourseDescription( "ENG101","08","08:30 - 10:00","TR","AB2-404","40"));
        this.courseDescriptionRepository.save(new CourseDescription( "ENG101","09","01:30 - 03:00","S","223","40"));
        this.courseDescriptionRepository.save(new CourseDescription( "ENG101","09","01:30 - 03:00","T","221","40"));
        this.courseDescriptionRepository.save(new CourseDescription( "MAT101","01","01:30 - 03:00","MW","AB1-202","40"));
        ...
        this.courseDescriptionRepository.save(new CourseDescription( "MAT101","02","11:50 - 01:20","ST","AB1-302","40"));
        this.courseDescriptionRepository.save(new CourseDescription( "MAT101","03","01:30 - 03:00","TR","AB1-302","40"));
        this.courseDescriptionRepository.save(new CourseDescription( "MAT101","04","11:50 - 01:20","ST","AB1-602","40"));
        this.courseDescriptionRepository.save(new CourseDescription( "MAT101","05","03:10 - 04:40","SR","AB1-602","40"));
        this.courseDescriptionRepository.save(new CourseDescription( "MAT101","06","11:50 - 01:20","MW","AB1-301","40"));
        this.courseDescriptionRepository.save(new CourseDescription( "MAT101","07","11:50 - 01:20","TR","AB1-402","40"));
        this.courseDescriptionRepository.save(new CourseDescription( "MAT101","08","11:50 - 01:20","S","AB1-402","40"));
        this.courseDescriptionRepository.save(new CourseDescription( "MAT101","08","11:50 - 01:20","R","AB1-302","40"));
        this.courseDescriptionRepository.save(new CourseDescription( "MAT101","09","10:10 - 11:40","ST","AB1-502","40"));
        this.courseDescriptionRepository.save(new CourseDescription( "CSE105","01","08:30 - 10:00","ST","110","40"));
        this.courseDescriptionRepository.save(new CourseDescription( "CSE105","02","11:50 - 01:20","MW","108","40"));
        this.courseDescriptionRepository.save(new CourseDescription( "CSE105","03","11:50 - 01:20","ST","110","40"));
        this.courseDescriptionRepository.save(new CourseDescription( "CSE105","04","08:30 - 10:00","MW","630 (Software Engineering Lab)","40"));
        this.courseDescriptionRepository.save(new CourseDescription( "MAT104","01","11:50 - 01:20","MW","358","40"));
        ...
        this.courseDescriptionRepository.save(new CourseDescription( "MAT104","02","01:30 - 03:00","SR","359","40"));
        this.courseDescriptionRepository.save(new CourseDescription( "MAT104","03","11:50 - 01:20","ST","433","40"));
        this.courseDescriptionRepository.save(new CourseDescription( "MAT104","04","01:30 - 03:00","T","432","40"));
        this.courseDescriptionRepository.save(new CourseDescription( "MAT104","04","01:30 - 03:00","R","219","40"));
        this.courseDescriptionRepository.save(new CourseDescription( "MAT104","05","01:30 - 03:00","R","437","40"));
        this.courseDescriptionRepository.save(new CourseDescription( "MAT104","05","01:30 - 03:00","S","AB1-302","40"));
        this.courseDescriptionRepository.save(new CourseDescription( "MAT104","06","11:50 - 01:20","MW","AB1-501","40"));
        this.courseDescriptionRepository.save(new CourseDescription( "MAT104","07","11:50 - 01:20","ST","531","40"));
        this.courseDescriptionRepository.save(new CourseDescription( "MAT104","08","03:10 - 04:40","MW","532","40"));
        this.courseDescriptionRepository.save(new CourseDescription( "MAT104","09","01:30 - 03:00","TR","AB2-404","40"));
        this.courseDescriptionRepository.save(new CourseDescription( "CHE109","01","08:30 - 10:00","SR","109","40"));
        this.courseDescriptionRepository.save(new CourseDescription( "CHE109","02","11:50 - 01:20","TR","AB1-301","40"));
        this.courseDescriptionRepository.save(new CourseDescription( "CHE109","03","03:10 - 04:40","MW","107","40"));
        this.courseDescriptionRepository.save(new CourseDescription( "CHE109","04","08:30 - 10:00","T","102","40"));
        this.courseDescriptionRepository.save(new CourseDescription( "CHE109","04","08:30 - 10:00","R","108","40"));
        this.courseDescriptionRepository.save(new CourseDescription( "CHE109","05","10:10 - 11:40","TR","102","40"));
        this.courseDescriptionRepository.save(new CourseDescription( "CHE109","06","11:50 - 01:20","SR","113","40"));
        this.courseDescriptionRepository.save(new CourseDescription( "CHE109","07","10:10 - 11:40","SR","212","40"));
        this.courseDescriptionRepository.save(new CourseDescription( "CSE109","01","08:30 - 10:00","ST","221","40"));
        this.courseDescriptionRepository.save(new CourseDescription( "CSE109","02","01:30 - 03:00","MW","AB1-201","40"));
        this.courseDescriptionRepository.save(new CourseDescription( "CSE109","03","11:50 - 01:20","MW","AB2-302","40"));
        this.courseDescriptionRepository.save(new CourseDescription( "CSE109","04","11:50 - 01:20","S","AB2-203","40"));
